...
SOURCE = ROOT / "experiments/sd_membership_sft"
...
def test_extracted_helpers_have_one_implementation():
    from experiments.shared.core import audit_metrics, audit_runtime, replay_cache
    from experiments.sd_membership_sft.archive import adaptive_window_accept_only, full_delta_mia, neural_adaptive_accept_only, stat_delta_mia
...
def test_lowq_baseline_matches_historical_ties_short_records_and_budgets():
    ...
    from experiments.shared.methods.conditional_accept_only import Observations, lowq_score
...
def test_mainline_fit_preserves_historical_static_detector(dimensions):
    from experiments.shared.methods import difficulty_accept_only as current
...
def test_mainline_loads_legacy_draft_feature_manifest(tmp_path, monkeypatch):
    from experiments.shared.methods import difficulty_accept_only as current
    from experiments.shared.core.replay_cache import ReplayData
