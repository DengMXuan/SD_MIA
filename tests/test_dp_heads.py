...
from experiments.sd_membership_sft.datasets.data import SFTRecord
from experiments.sd_membership_sft.audit.matrix_artifacts import digest
from test_dp_defense import tiny_model, TinyTokenizer, single_thread
...
def test_eagle_member_and_aux_use_same_temperature_kl(member, monkeypatch):
    from experiments.dp_defense.head_train import head_loss
    from experiments.sd_membership_sft.drafts import eagle3
    calls = []
...
def test_dp_head_lifecycle_routes_data_freezes_target_and_resumes(tmp_path, monkeypatch, pair):
    ...
    from experiments.sd_membership_sft import splits
    from experiments.sd_membership_sft.drafts import common
