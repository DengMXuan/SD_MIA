...
from experiments.shared.data.pools import _write_pool, merge_pool_files
from experiments.shared.data.pool_storage import read_verified_pool
...
def test_pool_reader_recovers_interrupted_data_manifest_commit(
    ...
    from experiments.shared.data import pool_storage
