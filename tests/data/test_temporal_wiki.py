...
from experiments.baseline.types import AuditRecord
from experiments.shared.data.data import SFTRecord, _hash_ids
from experiments.shared.data.pools import _write_pool
...
def test_collected_token_selection_survives_frozen_pool_reselection():
    from experiments.shared.data.pools import _select_wiki_records
