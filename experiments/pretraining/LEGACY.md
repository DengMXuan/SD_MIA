# Legacy Pythia / MIMIR baselines and M1 workflow

For the current fixed B=2 main method, use [README.md](README.md).
The M1 detector and partitions below belong to the archived method and must not
be mixed with current main-method reports.
