...
from experiments.sd_membership_sft.matrix_metrics import metrics, roc_operating_point
from experiments.sd_membership_sft.matrix_artifacts import digest, read_result, save_result
from experiments.sd_membership_sft.matrix_baselines import BASELINE_DEFAULTS
from experiments.sd_membership_sft.qwen_audit_matrix import make_tasks, summarize, ready, check_gpus
...
def test_main_matrix_uses_both_draft_roles_and_resumes_frozen_detector(tmp_path, protocol):
    ...
    from experiments.sd_membership_sft.protocol_archive import save_archive
...
def test_gpu_preflight_rejects_busy_or_invalid_indices(monkeypatch):
    import experiments.sd_membership_sft.qwen_audit_matrix as launcher
...
def test_draft_checkpoint_roles_cannot_silently_fall_back_to_kd(tmp_path):
    from experiments.sd_membership_sft.protocol_models import checkpoint_paths
...
def test_modified_source_and_partial_results_are_not_complete(tmp_path):
    ...
    from experiments.sd_membership_sft.qwen_audit_matrix import inspect_task
...
def test_cancelled_worker_is_reaped_before_return(force_kill):
    import subprocess
    import threading
    from experiments.sd_membership_sft.qwen_audit_matrix import wait_worker
...
def test_generation_batch_accounting_keeps_calibration_separate():
    from experiments.sd_membership_sft.matrix_baselines import PhaseMeter, PhaseProgress
