...
from experiments.sd_membership_sft.core.audit_partitions import legacy_partitions
from experiments.sd_membership_sft.core.audit_runtime import ROOT, SPLIT_SEED, _paths, _write_json
from experiments.sd_membership_sft.methods.lowq_baseline import lowq_fragment_scores, standardized_max
...
def main() -> None:
    ...
    output = args.output_dir or ROOT / "artifacts/runs/analysis/conditional_accept_only" / condition / f"b{args.budget}_seed{args.seed}"
