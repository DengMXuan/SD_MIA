...
from experiments.sd_membership_sft.protocols.protocol_models import load_adapter
from experiments.sd_membership_sft.methods.protocol_accept_only import CausalAcceptanceGRU, fit_causal, natural_features, trajectory_partitions, predict
from experiments.sd_membership_sft.protocols.sd_protocol import natural_trace, fixed_trace, resolve_starts
from experiments.sd_membership_sft.audit.matrix_artifacts import already_complete, digest, save_result
from experiments.sd_membership_sft.audit.matrix_costs import PHASES, timed, peak_memory, summarize_cost, COST_CONVENTIONS
...
def fit_detector(data, parts, task, output):
    ...
    with timed() as fitting:
        ...
        if protocol == "natural":
            ...
            from experiments.sd_membership_sft.methods.difficulty_accept_only import fit
