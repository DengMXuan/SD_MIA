...
from .collect_protocol_observations import collect_records, protocol_prompt_ids
from .conditional_accept_only import ConditionalCountTCN
from .deployment_archive import sha256_file
from .protocol_archive import load_archive
from .protocol_models import load_adapter
from .protocol_accept_only import CausalAcceptanceGRU, fit_causal, natural_features, trajectory_partitions, predict
from .sd_protocol import natural_trace, fixed_trace, resolve_starts
from .matrix_artifacts import already_complete, digest, save_result
from .matrix_costs import PHASES, timed, peak_memory, summarize_cost, COST_CONVENTIONS
from .matrix_metrics import metrics, METRIC_CONVENTIONS
...
def fit_detector(data, parts, task, output):
    ...
    with timed() as fitting:
        ...
        if protocol == "natural":
            ...
            from .difficulty_accept_only import fit
    ...
    temporary.replace(output / "detector.pt")
