...
from experiments.shared.audit.artifacts import digest, checkpoint_inventory, read_result, save_result, already_complete, runtime_files as shared_runtime_files
from experiments.shared.core.deployment_archive import checkpoint_fingerprint, sha256_file


def runtime_files():
    extra = list((ROOT / 'experiments/cross_model_audit').glob('*.py'))
