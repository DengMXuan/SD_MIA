...
import numpy as np
import torch
from experiments.shared.methods.conditional_accept_only import ConditionalCountTCN, observable_inputs
from experiments.shared.core.audit_partitions import legacy_partitions as record_partitions
from experiments.shared.methods.difficulty_accept_only import OUTPUT as PRIORITY, RESULTS, load_feature_observations, predict, aggregate, expanded_calibration, group_pvalues
...
def matrix(args):
    ...
    def run(case):
        ...
        command=[sys.executable,'-m','experiments.shared.methods.combined_accept_only','evaluate',
