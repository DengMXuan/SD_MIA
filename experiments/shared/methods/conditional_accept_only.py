...
from experiments.shared.core.audit_partitions import legacy_partitions
from experiments.shared.core.audit_runtime import ROOT, SPLIT_SEED, _paths, _write_json
from experiments.shared.methods.lowq_baseline import lowq_fragment_scores, standardized_max
...
def main() -> None:
    ...
    output = args.output_dir or ROOT / "artifacts/audits/conditional_accept_only/tasks" / condition / f"b{args.budget}_seed{args.seed}"
